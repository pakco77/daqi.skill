...
<p align="center"><strong>点子孵化器：痛点记成情报，点子养出计划。达奇不会背叛你。</strong></p>
...
你随口提的每个痛点、每个点子，他都替你记进营地账本；他会去重、会养大、会记得每一票干到哪了，但**只有你点头，队伍才出发**。数据全在本地 `~/.daqi`，不上传、不读完整对话、不存秘密。
...
│   │   ├── SKILL.md
│   │   ├── assets/            # SELF / SHELF / POOL / NOW / HANDOFF 模板
